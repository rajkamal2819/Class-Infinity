...
public class RelavanceCourses extends Fragment {


    public RelavanceCourses() {
        // Required empty public constructor
    }

    FragmentRelavanceCoursesBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentRelavanceCoursesBinding.inflate(getLayoutInflater());
        ...
        binding.nestedScrollView.setOnScrollChangeListener(new NestedScrollView.OnScrollChangeListener() {
            ...
            public void onScrollChange(NestedScrollView v, int scrollX, int scrollY, int oldScrollX, int oldScrollY) {
                if(scrollY == v.getChildAt(0).getMeasuredHeight() - v.getMeasuredHeight()){
                    ...
                    Log.i("Relevance Courses","Link: "+link);
    ...
    protected void updateUi(ArrayList<Courses> booksInfos) {
        ...
        CoursesItemAdapter sliderAdapter = new CoursesItemAdapter(booksInfos, binding.recyclerViewRelevance, getContext(), R.layout.courses_item_specific, 2);
        binding.recyclerViewRelevance.setAdapter(sliderAdapter);
        binding.recyclerViewRelevance.setLayoutManager(new GridLayoutManager(getContext(), 2));
